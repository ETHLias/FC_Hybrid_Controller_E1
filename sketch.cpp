...
//  TODO: Note that the minimum battery power request is not needed, our system is inherently safe for that.
...
double finalizing_power_split_V2 (const double Q,
                               const double P_BAT_UB,
                               const double P_BAT_LB,
                               const double P_BAT_min_req,
                               const double P_FC_max,
...
int main () {
    ...
    double P_FC_req = finalizing_power_split_V2 (Q,
                                              Limiter.P_BAT_UB,
                                              Limiter.P_BAT_LB,
